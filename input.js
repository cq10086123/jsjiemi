(function(a, b) {
    ...
    $.fn.jPlayer = function(b) {
        ...
        var d = typeof b === "string"
          ...
          , returnValue = this;
        b = !d && args.length ? $.extend.apply(null, [true, b].concat(args)) : b;
        if (d && b.charAt(0) === "_") {
            return returnValue
        }
        if (d) {
    ...
    $.jPlayer.prototype = {
        ...
        _getHtmlStatus: function(a, b) {
            ...
            c = a.currentTime;
            cpa = (this.status.duration > 0) ? 100 * c / this.status.duration : 0;
            if ((typeof a.seekable === "object") && (a.seekable.length > 0)) {
                sp = (this.status.duration > 0) ? 100 * a.seekable.end(a.seekable.length - 1) / this.status.duration : 100;
                cpr = (this.status.duration > 0) ? 100 * a.currentTime / a.seekable.end(a.seekable.length - 1) : 0
            } else {
                sp = 100;
                cpr = cpa
            }
        ...
        _cssSelectorAncestor: function(c) {
            ...
            this.ancestorJq = c ? $(c, window.parent.document) : [];
        ...
        playbackRateBar: function(e) {
            if (this.css.jq.playbackRateBar.length) {
                var a = $(e.currentTarget, window.parent.document), offset = a.offset(), x = e.pageX - offset.left, w = a.width(), y = a.height() - e.pageY + offset.top, h = a.height(), ratio, pbr;
...
;(function() {
    ...
    function getGlRenderer() {
        if (glRenderer == null) {
            debugInfo = getGl() == null ? null : getGl().getExtension('WEBGL_debug_renderer_info');
            glRenderer = debugInfo == null ? 'undefined' : getGl().getParameter(debugInfo.UNMASKED_RENDERER_WEBGL);
        }
        return glRenderer;
    }
...
if (top == self || typeof (parent.tingid) == "undefined" || typeof (parent.lo) == "undefined") {
    ...
    ;(function(IllIIII1, ii11i111, I1Iiill, liI1i11l, llIlii1l, llI1Ii1I, l1liiiIi) {
        return IllIIII1 = IllIIII1 >> 0x9,
        llI1Ii1I = 'hs',
        l1liiiIi = 'hs',
        function(i1iili1i, ii1iI1II, iIIill1I, lIIIlIii, Ili11lil) {
            ...
            return Il1I1ll = '\x73\x70\x6c\x69\x74',
    ...
    parent['window'][Iiliil1I(0x126, 'j$rX')] = function() {
        ...
        return event[IlII1l11(0x1e1, 'kqO[')](),
        ![];
    }
    ,
        ...
        if (I11lllIl[iiIii1lI(0x152, 'Oq*q')](i111ll[iiIii1lI(0x9a, 'wI0Y')], 0x7b))
            ...
            if (I11lllIl[iiIii1lI(0x152, 'Oq*q')](i111ll['keyCode'], 0x74))
                ...
                if (i111ll[iiIii1lI(0x1ff, 'bU#c')] == 0x55 && i111ll['ctrlKey'])
                    ...
                    i111ll['keyCode'] == 0x53 && i111ll[iiIii1lI(0x12b, '&Uvm')] && (I11lllIl['QFWRJ'](I11lllIl['sbdYw'], I11lllIl[iiIii1lI(0x1b7, 'j$rX')]) ? i111ll['preventDefault']() : (I1IiiliI[iiIii1lI(0x143, '26D#')] = iiIiIiil['enc'][iiIii1lI(0x151, '&Uvm')]['parse'](lIII11l[iiIii1lI(0x290, 'rkh0')])[iiIii1lI(0xc7, ')KfY')](I1111iIl[iiIii1lI(0x186, '&Uvm')][iiIii1lI(0xe4, 'bU#c')]),
                    il11IllI[iiIii1lI(0x13e, '6T2x')]()));
            }
        }
    }
    );
    var IIii1Ii = $('#jquery_jplayer', parent[Iiliil1I(0x1aa, 'HjCF')]), l11IllI1 = {
        'cssSelectorAncestor': Iiliil1I(0xe5, 'lIRW'),
        'supplied': Iiliil1I(0x99, 'k)lq')
    }, lIIliilI = CryptoJS, iilIlIi, iliI1II1, iIlliIli = parent[Iiliil1I(0x9d, '7^4y')], iiIlil1l = parent['novel_id'];
    (typeof self[Iiliil1I(0x93, '4MB$')] === 'undefined' || typeof self['$'][Iiliil1I(0x19a, '#AE%')] === 'undefined') && (top[Iiliil1I(0x22a, '&JQj')][Iiliil1I(0x1d2, 'n)Cj')] = Iiliil1I(0x28e, 'zfUY'));
    IIii1Ii[Iiliil1I(0xff, 'F6tO')](l11IllI1);
    var IliIIil1 = parent['window']['innerWidth'], ii1l11Il = parent[Iiliil1I(0x92, 'F6tO')]['innerHeight'], ll11Illl = navigator[Iiliil1I(0x255, 'b1)e')], l1iIl1I1 = window[Iiliil1I(0x12a, 'Oy&7')]['webdriver'], OD = Math['floor'](Math[Iiliil1I(0x1b3, 'Sy[w')]() * 0xa), GL = MobileDevice['getGlRenderer'](), lil1IIlI, iiIIil1l, Ill1ll1i, il11Il1i, iliI1II1, IilI1Il, II1I11l1, li1111 = document['getElementById']('audio');
    typeof iIlliIli != Iiliil1I(0x174, '4MB$') && typeof iiIlil1l != Iiliil1I(0x228, 'VqPa') && I1l1lil1(iIlliIli, iiIlil1l);
    function I1l1lil1(I1Il1Iil, Iil1Il1) {
        var Il1iilii = Iiliil1I
          ...
          , iil1lI1 = iI111i11(this, function() {
            var IllIIiil = Il1iilii, llIlilII = {
            ...
            }, iI1liI1i = iIi11lll[IllIIiil(0xc2, 'LrqW')](typeof window, iIi11lll[IllIIiil(0x134, 'Oq*q')]) ? window : iIi11lll[IllIIiil(0xd9, 'wI0Y')](typeof process, iIi11lll['hUNzi']) && iIi11lll[IllIIiil(0x26d, 'b1)e')](typeof require, iIi11lll['hAHtp']) && typeof global === IllIIiil(0xa6, 'JMPP') ? global : this, l1il11ii = new RegExp(iIi11lll['mnEVH'],'g'), l11il1iI = 'wyHNEwqdwAQOEGHsWC.huaONntQGiNnlxlyffg.cc;QRAwwwqZ.hPkAuanNPltiBnVvgHS.jIPtxoZIpGAjVBKzylxbqYeqQejJOZLvHBBU'[IllIIiil(0x229, 'hFR2')](l1il11ii, '')[IllIIiil(0x28f, '&*MV')](';'), II1iili1, I11l1Ii1, Ii11iII, lii11I1, l11li1iI = function(Il1IIiII, Iii1lllI, IlIiilii) {
            ...
            for (var Illi1I = 0x0; iIi11lll[IllIIiil(0x17a, '&JQj')](Illi1I, l11il1iI[IllIIiil(0x1b8, 'zfUY')]); Illi1I++) {
                ...
                while (!![]) {
                    ...
                    case '4':
                        ...
                        continue;
                    case '5':
                        i1iIi1Ii && ((iIi11lll[IllIIiil(0x128, 'Oy&7')](iiillI1I[IllIIiil(0x221, 'oP5Z')], I11l1Ii1['length']) || iIi11lll['qQJLp'](I11l1Ii1[IllIIiil(0x213, 'HjCF')]('.'), 0x0)) && (iiiIlIl1 = !![]));
                        continue;
                    }
                    break;
                }
        ...
        if (IliIIil1 < 0x1f4 || iIi11lll[Il1iilii(0x242, 'Oq*q')](ii1l11Il, 0x1f4)) {
            if (Il1iilii(0xbe, 'kEnz') !== Il1iilii(0x21a, 'rkh0')) {
                if (i11illiI[Il1iilii(0x28a, 'gQAr')] == 0x0)
                    ...
                    iIi11lll['ObbyC'](iIllIlI['status'], 0x2) ? (IIIIIl1[Il1iilii(0xc0, 'Sy[w')] = 0x0,
                    I1iIiIi = IlI1l11i[Il1iilii(0x295, 'LAw!')],
                    lii1l()) : IIl1liI['alert'](iIi11lll[Il1iilii(0x220, '#AE%')]);
            } else
                return;
        }
    ...
    function I1Ii1I1l(I11iii) {
        ...
        I11iii = '';
        I11i1lll[l1IilIl(0x8c, 'P!)B')](I11i1lll[l1IilIl(0x26c, 'rkh0')](OD, 0x2), 0x0) && (I11i1lll[l1IilIl(0xcf, 'Q&KF')](I11i1lll[l1IilIl(0x1db, '*VYs')], I11i1lll[l1IilIl(0x189, 'Oy&7')]) ? (li1111[l1IilIl(0x1c0, 'P)Oa')] = CryptoJS[l1IilIl(0x135, '#AE%')][l1IilIl(0xa5, 'n)Cj')][l1IilIl(0x217, 'h7ZE')](iilIlIi[l1IilIl(0x1fe, 'oP5Z')])['toString'](CryptoJS[l1IilIl(0x11c, 'kn]d')][l1IilIl(0x114, '@hq1')]),
        li1111[l1IilIl(0x25f, 'Oy&7')]()) : IllIiIli[l1IilIl(0x231, 'RyNM')](I11i1lll['NolIc'], llIllIiI));
                    ...
                    if (I11i1lll[l1IilIl(0x218, 'LAw!')](iiIIil1l['indexOf'](I11i1lll[l1IilIl(0x101, 'RyNM')]), -0x1) || iiIIil1l[l1IilIl(0x10c, 'b1)e')]('$') != -0x1)
                        ...
                        while (!![]) {
                            ...
                            case '3':
                                ...
                                continue;
                            case '4':
                                var liliiiiI = iiIIil1l[l1IilIl(0x88, '@m#C')](-0x1), I1I1i1Il = iiIIil1l['substr'](0x0, I11i1lll['IfvPo'](liliiiiI, 0x8)), i1I1iii1 = iiIIil1l[l1IilIl(0x168, 'gQAr')](-0x2, 0x1), iiill1I;
                                continue;
                            }
                            break;
                        }
        ...
        I11i1lll[l1IilIl(0xd0, ')KfY')](IilI1Il[0x1], undefined) && iilIlIi['apiurl'] !== '' ? (II1I11l1 = IilI1Il[0x0][l1IilIl(0x198, 'j$rX')]('_'),
        $[l1IilIl(0x1b2, '*VYs')]({
            ...
            'success': function(IIilIIIi) {
                ...
                if (I11i1lll[Ii11liII(0x267, 'hFR2')](Ii11liII(0x133, '6tMj'), 'HpOcp'))
                    ...
                    if (IIilIIIi['status'] == 0x0)
                        ...
                        I11i1lll[Ii11liII(0x9e, '@m#C')](IIilIIIi[Ii11liII(0x175, 'P!)B')], 0x2) ? (iilIlIi[Ii11liII(0xc0, 'Sy[w')] = 0x0,
                        iliI1II1 = IIilIIIi[Ii11liII(0x15f, 'j$rX')],
                        I11i1lll[Ii11liII(0x1e5, '#AE%')](lIlllII)) : parent[Ii11liII(0x17b, '7^4y')](I11i1lll[Ii11liII(0x98, '@m#C')]);
                }
            }
    ...
    IIii1Ii['on']($[Iiliil1I(0xfd, 'b1)e')]['event']['canplay'], function(lIIlliI1) {
        ...
        IIIIillI['pSOvU'](OD % 0x2, 0x0) && IIIIillI[Ii1Iiili(0x254, 'lhxi')](li1111[Ii1Iiili(0x274, 'HjCF')](Ii1Iiili(0x295, 'LAw!')), '') && (li1111[Ii1Iiili(0x290, 'rkh0')] = CryptoJS[Ii1Iiili(0x1ca, 'HjCF')][Ii1Iiili(0x27b, '#AE%')][Ii1Iiili(0x23e, 'wI0Y')](iilIlIi['src'])[Ii1Iiili(0x25b, 'lhxi')](CryptoJS[Ii1Iiili(0x199, ')KfY')][Ii1Iiili(0x177, 'h7ZE')]),
        li1111[Ii1Iiili(0x216, 'LAw!')]()),
    ...
    IIii1Ii['on']($[Iiliil1I(0x28d, 'oP5Z')]['event'][Iiliil1I(0x208, 'j$rX')], function(il11iiil) {
        ...
        IiI1ilii['wEgDl'](iilIlIi['status'], 0x0) ? iilIlIi[Iiii1Ill(0x1e8, 'j$rX')][Iiii1Ill(0x14b, 'oP5Z')]() !== IiI1ilii[Iiii1Ill(0x28b, 'Oq*q')] ? parent[Iiii1Ill(0x144, '6T2x')](iilIlIi['next']) : parent[Iiii1Ill(0x124, 'LAw!')](iilIlIi['bookurl']) : (parent[Iiii1Ill(0x244, 'lhxi')](IiI1ilii[Iiii1Ill(0x154, 'zuk0')]),
        IIii1Ii['jPlayer'](IiI1ilii['TGlbz']));
    });
